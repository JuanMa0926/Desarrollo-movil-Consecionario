...
import { firebaseApp } from '../firebaseConfig'; // Importa la configuración de Firebase desde tu archivo firebaseConfig

const auth = getAuth(firebaseApp); // Inicializa Firebase Auth con la configuración importada
